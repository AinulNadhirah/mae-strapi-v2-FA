...
export const ENSURE_MYKAD_PASSPORT_READABLE = "Ensure your MyKad or passport is clear and readable";
...
export const ZEST_CASA_KYC_ENTRY_DESCRIPTION =
    "We need to know if it’s really you. Let’s take a selfie and capture your ID.";
...
export const DEBIT_CARD_PAYMENT_NOTE =
    "Note: You will be charged RM8 upon successful card application.";
...
export const ZEST_CASA_ACCOUNT_ACTIVATE_FAILED =
    "We could not verify your account name. Please visit a branch to activate this account within 10 days from opening it. We will initiate a refund to your original account.";
...
export const FILL_IN_DEBIT_CARD_RESIDENTIAL_DETAILS = "Please fill in your mailing address";
...
export const NON_BANK_COMMIT_TITLE = "Monthly non-bank commitments";
...
export const ASB_GUARANTOR_PERSONAL_INFORMATION_SUB_HEADING = "Please fill in your details";
...
export const GUARANTOR_ARE_YOU_US_PERSON = "Are you a United States of America (US)  \nperson?";
...
export const ASB_GUARANTOR_DISCLOSURE = "Disclosure letter by customer on all";
...
export const TOTAL_MONTHLY_NON = "Total monthly non-bank commitments";
export const TOTAL_MONTHLY_NON_TOOLTIP = "Total monthly non-bank \ncommitments";
...
export const INCLUDIN_YOU_MONTHLY_COMMITMENTS =
    "Include your monthly \ncommitments to non-banking \ninstitutions. E.g. Aeon credit, \nSyarikat motor loan, Courts, Seng \nHeng, ELK car finance.";
...
export const LEAVE_TITLE = "Are you sure you want to leave this application";
...
export const NOTIFY_GUARANTOR = "Notify guarantor to input their \ndetails?";
...
export const NOMINATED_YOU = (mainAppplicantName) =>
    `${mainAppplicantName} has nominated you as a guarantor \nfor ASB financing application`;
export const REVIEW_INFO = "Review information to insure its accurate before \naccepting";
export const BECOME_GUARANTOR = "Become a guarantor";
export const PLEASE_SHARE_WITH_US_INCOME_COMMITMENT_DETAILS =
    "Please share with us your income and \ncommitment details";
...
export const ASB_PRIVACY_AGREE =
    "I have read, agree and accept the terms of the The Maybank Group Personal Data Privacy Statement. For marketing of products and services by Maybank Group/ Other Entities referred to in the";
...
export const DECLINE_BECOME_GUARANTOR_DESC = (mainAppplicantName) =>
    `Please note that this action cannot be reverset. ${mainAppplicantName} will be notified on this action`;
export const DECLINE_BECOME_GUARANTOR_TOAST =
    "You'we rejected the request to become a guarantor for financing application.";
...
export const ASB_CASA_PRIMARY_INCOME = "Primary income";
...
export const ZAKAT_SUCCESS_DATE_NOTIFIER =
    "Your Zakat Simpanan & Pelaburan will be calculated on 31 Oct every year.";
...
export const ZAKAT_NO_ISLAMICACCT_TO_SELECT =
    "You must have a Maybank Islamic account/product to set up auto debit for zakat";
