...
import { APPLY_SAVINGSI_INTRO_SCREEN } from "@screens/Premier/helpers/AnalyticsEventConstants";
import {
...
import { SAVINGSI_ACCOUNT_ID, KAWANKU_SAVINGSI_PRODUCT_NAME } from "@constants/premierStrings";
...
const KawankuSavingsIIntroScreen = (props) => {
    const { navigation, route } = props;
    const { isKawankuSavingsI } = route.params;
    ...
    const init = () => {
        console.log("[KawankuSavingsIIntroScreen] >> [init]");
        dispatch({ type: ZEST_CASA_CLEAR_ALL });
        props.updateIsKawankuSavingsI(isKawankuSavingsI);
    ...
    function onBackTap() {
        console.log("[KawankuSavingsIIntroScreen] >> [onBackPress]");
        handlePremierTapFlow(dispatch, props);
        navigation.goBack();
    }

    function onCloseTap() {
        console.log("[KawankuSavingsIIntroScreen] >> [onCloseTap]");
    ...
    function onApplyNow() {
        console.log("[KawankuSavingsIIntroScreen] >> [applyNow]");
        console.log("status--", props.statusDownTime);
    ...
    return (
        <ScreenContainer backgroundType="color" analyticScreenName={APPLY_SAVINGSI_INTRO_SCREEN}>
            <ScreenLayout
                header={
                    <HeaderLayout
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    >
                        <IntroScreenViewSelection
                            ...
                            accountImage={Assets.KawankuSavingsIEntryHeader}
                        />
                    </KeyboardAwareScrollView>
                </ScrollView>
...
export const entryPropTypes = (KawankuSavingsIIntroScreen.propTypes = {
    ...commonPropTypes,
    statusDownTime: PropTypes.string,
});

export default entryProps(downTimeServiceProps(masterDataServiceProps(KawankuSavingsIIntroScreen)));
